...
class App(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.arduino = ArduinoHandler('COM4',self.ui.listWidget)
        ...
        self.ui.toolButton_emgstop.clicked.connect(lambda:self.handle_button_click('re'))
    ...
    def update_data_label(self, data):
        ...
        try:
            ...
            if isinstance(numeric_value, float):
                self.ui.widget.value=int(numeric_value)
